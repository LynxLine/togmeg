...
:QWidget(parent)
{
    ...
    footerLayout->addItem(new QSpacerItem(20,10, QSizePolicy::Fixed, QSizePolicy::Minimum),0,0);
    ...
    footerLayout->addItem(new QSpacerItem(20,10, QSizePolicy::Fixed, QSizePolicy::Minimum),0,5);

    //footerLayout->setColumnStretch(0,05);
    //footerLayout->setColumnStretch(2,20);
    //footerLayout->setColumnStretch(3,70);
    //footerLayout->setColumnStretch(4,05);
