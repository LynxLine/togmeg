...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    WordListController * wordListController = [[WordListController alloc] init];
    wordListController.navigationController = self.navigationController;
    wordListController.title = @"All";
