...
void GradientWidget::setGradient(QGradient g)
{
    d->gradient = g;
    if (d->gradient.type() == QGradient::LinearGradient) {
        QLinearGradient * linearGradient = (QLinearGradient *)&d->gradient;
...
QFont GradientWidget::windowTitleFont()
{
    return d->windowTitleFont;
}

void GradientWidget::setWindowTitleFont(QFont f)
{
    d->windowTitleFont = f;
...
qreal GradientWidget::roundRadius()
{
    return d->roundRadius;
}

void GradientWidget::setRoundRadius(qreal r)
{
    d->roundRadius = r;
}
